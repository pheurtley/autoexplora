...
export function MicrositeFooter({ config }: MicrositeFooterProps) {
  const { dealer } = config;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            {/* Social Links */}
            {(config.socialInstagram || config.socialFacebook || config.socialTiktok || config.socialYoutube) && (
              <div>
        ...
        {/* Bottom bar */}
        <div className="mt-10 pt-6 border-t border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-neutral-500">
          <p>
            &copy; {new Date().getFullYear()} {dealer.tradeName}. Todos los
            derechos reservados.
          </p>
          <a
            href="https://autoexplora.cl"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-neutral-300 transition-colors"
          >
            Powered by AutoExplora.cl
          </a>
        </div>
      </div>
    </footer>
